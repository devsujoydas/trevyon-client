    ...
    return (
        <div className='bg-[#F9E4CB] py-30'>
            ...
            <div className='w-main'>
                <h1 onClick={() => { navigate(-1) }} className='flex items-center gap-2 mb-14 text-2xl cursor-pointer'><ArrowLeft /> Back to Account</h1>

                <div className='p-10 bg-white'>
                    <div className='flex justify-between items-center'>
                        <h1 className='font-semibold text-3xl'>Order ORD-12345</h1>
                        <h1 className='bg-[#16653433] text-[#166534] px-3 py-1 text-sm rounded-full'>Shipped</h1>
                    </div>
                    <div className=' text-xl text-zinc-700 flex justify-between items-center mt-2'>
                        <h1>Placed on May 15, 2023</h1>
                    </div>
                    <div className="flex items-center gap-5 my-5 text-sm">
